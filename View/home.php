...
$userInfo = $userController->getUser($user_id, $user_fullname, $email);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['weight'], $_POST['height'])) {
        ...
        if ($imcResult["BMIrange"] != "Por favor, informe seu peso e altura.") {
            ...
            <div class="result__IMC rounded-3 w-100">
                ...
                <div class="result">
                    <div class="result__info">
                        <?php if ($imcResult): ?>
                            <p>Resultado: <?php echo $imcResult["imc"]; ?> </p>
                            <p>Categoria: <?php echo $imcResult["BMIrange"]; ?> </p>
                        <?php else: ?>
                            <i class="bi bi-calculator"></i>
                            <p>Preencha os dados para obter o resultado.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
